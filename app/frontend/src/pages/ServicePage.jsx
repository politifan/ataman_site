            ...
            {!service.is_draft && (supportsGroup || supportsIndividual) ? (
              <form className="side-card booking-form" onSubmit={handleSubmit}>
                ...
                {activeBookingEvents.length ? (
                  ...
                  <p className="muted">
                    {bookingMode === "individual"
                      ? "Для индивидуального формата пока нет опубликованных дат в расписании. Автор пока уточняет время."
                      : "Для данного направления пока нет опубликованных дат в расписании. Автор пока уточняет время."}
                  </p>
                )}
                <input
                  value={form.name}
